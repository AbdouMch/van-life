...
export default function HostVanDetailsLayout() {
    ...
    return (
        <div className="px-8">
            ...
            <div className="mt-10 flex flex-col bg-white p-6">
                ...
                {van && (
                    <>
                        ...
                        <nav className="mt-10 flex gap-4">
                            <HostVanNavLink end to={"."}>
                                Details
                            </HostVanNavLink>
                            <HostVanNavLink to={"pricing"}>Pricing</HostVanNavLink>
                            <HostVanNavLink to={"photos"}>Photos</HostVanNavLink>
                        </nav>
                        <div className="mt-10">
                            <Outlet context={{ van } satisfies HostVanContext} />
                        </div>
                    </>
                )}
            </div>
...
export function useHostVanContext(): HostVanContext {
    return useOutletContext<HostVanContext>()
}
